...
const Article = () => (
  <article className={styles.articleContent}>
    ...
    <p className={styles.body}>
      ...
      people like that better? The part I hated was showing my version to
      people. Go figure. Strangely enough, the vicious cycle above is ongoing,
      which I don't mind personally.
    </p>
    <p className={styles.body}>
      I make things—it makes me feel better. Software, photos, food, urban
      jungles, videos, clothes—just as long as it's helpful to me or others.
    </p>
    <p className={styles.body}>
      I design—it's my job. Currently, I design products at Pitch. I taught
      myself the basics by remaking other's work until I got stuck and needed
      help. I never liked the idea of learning the craft from a book or going to
    ...
    <p className={styles.body}>
      ...
      site for my thoughts. If you like them, reach out or not. If you feel it's
      stupid, that's fine—sometimes the feeling is mutual.
    </p>
    <p className={styles.body}>
