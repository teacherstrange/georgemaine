              ...
              {index === 0 && (
                <>
                  <MemojiImg
                    ...
                    alt={
                      "Memoji that matches Georgemaine's personality and mood"
                    }
                  />
              ...
              {index === 1 && (
                <>
                  ...
                  <Caption mobileWidth={"300px"} width={"330px"}>
                    <strong>2020. </strong>Designed Mollie’s iOS and Android
                    apps to make your phone a place where you can quickly manage
              ...
              {index === 4 && (
                <>
                  ...
                  <Caption mobileWidth={"300px"} width={"302px"}>
                    ...
                    to help support the official launch of Apple Pay to the
                    Dutch Mollie customers.
                  </Caption>
                </>
              )}
            </div>
